...
const Footer: React.FC<NavigationProps> = ({ homeRef, aboutRef }) => {
    ...
    <div className="footer">
        <div className='footerContent'>
            <div className='footerLeft'>
                <img className='logo' onClick={scrollToHome} src={logo} alt='logoFooter'/>
            ...
            <div className='footerRight'>
                <div className='footerRightInfoDiv'>
                    <span className='ourCompanySpan' onClick={scrollToAbout}>{translations.ourCompany}</span>
                </div>
                <div className='footerRightInfoDiv'>
